...
class BrgrController < ApplicationController
  def show
	...
	parsed_url = URI.parse('https://maps.googleapis.com/maps/api/place/radarsearch/json?' + @latitude + ',' + @longitude + '&radius=5000&types=food&sensor=false&key=AIzaSyC-CNui9DmsDGjlESFKa-iK42r1x11jywc')
